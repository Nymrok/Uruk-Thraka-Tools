-- ============================================================================
-- Template de bouton HD_Btn_RedGre
-- ============================================================================
...
-- Template de bouton HD_Btn_RedGrey (composé de deux parties)
function addon.ButtonTemplates.CreateHD_Btn_RedGrey(parent, text, width, height)
